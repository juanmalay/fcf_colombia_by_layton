...
abstract class $TeamModelCopyWith<$Res> {
  ...
  $Res call(
      {String id,
      String name,
      @JsonKey(fromJson: _logoUrlFromJson) String? logoUrl});
}
...
class _$TeamModelImpl extends _TeamModel {
  const _$TeamModelImpl(
      {required this.id,
      required this.name,
      @JsonKey(fromJson: _logoUrlFromJson) this.logoUrl})
      : super._();
  ...
  @override
  String toString() {
    return 'TeamModel(id: $id, name: $name, logoUrl: $logoUrl)';
  }
...
abstract class _TeamModel extends TeamModel {
  const factory _TeamModel(
          ...
          @JsonKey(fromJson: _logoUrlFromJson) final String? logoUrl}) =
      _$TeamModelImpl;
